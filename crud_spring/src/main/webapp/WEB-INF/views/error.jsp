...
<html lang="en">
  ...
  <body class="bck">
	...
	<div class="container">
		...
		<div class="alert alert-danger d-flex align-items-center py-3 my-3" role="alert">
		  <svg class="bi flex-shrink-0 me-2 mx-3" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
		  <div> ${msg} </div>
		</div>
	</div>
